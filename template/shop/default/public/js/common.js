		...
		$('.sidebar-tabs').click(function() {
			...
			switch($(this).attr("data-ns-flag")){
				...
				case "collections_goods":
					...
					$("#refreshMore").attr("href",shop_main+"/member/goodscollectionlist");
				...
				case "collections_shops":
					...
					title = "我收藏的店铺";
					$(".js-sidebar-title").prev().css("visibility","hidden");
					$("#refreshMore").text("查看更多收藏店铺");
					$("#refreshMore").attr("href",shop_main+"/member/shopcollectionlist");
					refreshShopOrGoodsCollections("shop");
					break;
				case "love_history":
					//我看过的，浏览历史
					title = "我看过的";

...
class Index extends BaseController
{
    ...
    {   
        ...
        //海尔专区
        $goodsbrandList_haier = $goods->getGoodsList(1,8,['ng.brand_id'=>10],'');
        
        //品牌专区
        $goodsbrand = new GoodsBrand();
        $goodsbrandList = $goodsbrand->getGoodsBrandList(1,12,'','');
        
     // dump($goodsbrandList_haier['data']);
        $assign_get_list = array(
            ...
            'goodsbrand_list' => $goodsbrandList["data"],  //品牌
            'goodsbrand_haier' => $goodsbrandList_haier["data"]  //海尔
        ); // 已选中商品分类一级
    ...
    public function selected()
    {
        ...
        return view($this->style . 'Index/selected');
    }
    ...
    public function intelligent()
    {
        ...
        //新品
        $this->getGoodsNew();
        return view($this->style . 'Index/intelligent');
    }
    /**
     * 拼单
     * @return Ambigous <\think\response\View, \think\response\$this, \think\response\View>
    ...
    public function fight(){
        return view($this->style . 'Index/fight');
    ...
    public function getGoodsNew(){
       $platform = new Platform();
       $new_goods_list = $platform->getPlatformGoodsRecommend(1);
       $this->assign('new_goods_list',array_values($new_goods_list));
    }
    ...
    public function getGoodsHot(){
        $platform = new Platform();
        $hot_goods_list = $platform->getPlatformGoodsRecommend(2);
        $this->assign('hot_goods_list',array_values($hot_goods_list));
    }

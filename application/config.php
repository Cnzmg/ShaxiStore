 ...
 * **************************************************************版本定义*******************************************************************************
 */
define('NS_VER_B2B2C', 'NS_VER_B2B2C'); // 多用户基础电商
define('NS_VER_B2B2C_FX', 'NS_VER_B2B2C_FX'); // 多用户分销
define('NS_VERSION', NS_VER_B2B2C);
/**
 * **************************************************************版本定义*******************************************************************************
 */
...
define('ADMIN_MODULE', "admin");//重新定义店铺端后台模块
...
//         'taglib_pre_load'     =>  'data\extend\Niu',
    ...
    'view_replace_str' => array(
        ...
        'PLATFORM_MAIN'=>__URL__.'/'.PLATFORM_MODULE,

<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:49:"template/platform/Wchat/weixinQrcodeTemplate.html";i:1581654383;s:27:"template/platform/base.html";i:1581654383;s:44:"template/platform/controlCommonVariable.html";i:1581654383;s:33:"template/platform/openDialog.html";i:1581654383;}*/ ?>
<!DOCTYPE html>
...
<header class="header clearfix">
	<div class="row m-t-sm">
		<a href="PLATFORM_MAIN/Wchat/qrcode" class="btn btn-sm btn-primary"><i class="fa fa-plus"></i> 添加自定义模板</a>
	</div>
</header>
<section class="panel panel-default">
	...
	<div class="panel-body">
		<div class="row">
		<?php if(is_array($template_list) || $template_list instanceof \think\Collection || $template_list instanceof \think\Paginator): if( count($template_list)==0 ) : echo "" ;else: foreach($template_list as $key=>$info): ?>
			...
			<?php if($info['is_check'] == 1): ?> 
				<img src="__UPLOAD__/<?php echo $info['template_url']; ?>" style="border:1px solid #00C0FF;width:100%;"/>
				<?php else: ?> 
					<img src="__UPLOAD__/<?php echo $info['template_url']; ?>" style="border:1px solid #eee;width:100%"/>
				<?php endif; ?>
			<div class="check" >
			<?php if($info['is_check'] == 1): ?> 
				<div style="margin-top:60%;" onclick="deleteWeixinQrcodeTemplateValid(<?php echo $info['id']; ?>)">
					<a href="javascript:;">删除</a>
				</div>
				<div onclick="modifyWeixinQrcode(<?php echo $info['id']; ?>)">
					<a href="javascript:;">编辑</a>
				</div>
				<?php else: ?> 
				<div style="margin-top:50%;" onclick="modifyWeixinQrcodeTemplateValid(<?php echo $info['id']; ?>)">
					<a href="javascript:;">设为默认</a>
				</div>
				<div onclick="deleteWeixinQrcodeTemplateValid(<?php echo $info['id']; ?>)">
					<a href="javascript:;">删除</a>
				</div>
				<div onclick="modifyWeixinQrcode(<?php echo $info['id']; ?>)">
					<a href="javascript:;">编辑</a>

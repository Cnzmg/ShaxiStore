<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:44:"template/wap/default//Order/myOrderList.html";i:1581921087;s:30:"template/wap/default/base.html";i:1581654581;}*/ ?>
<!DOCTYPE html>
<html>
<head>
        				...
        				for(var i=0;i<data.length;i++){
							...
							if(ordersitem['member_operation']!=''){
								for(var x=0;x<ordersitem['member_operation'].length;x++){
									...
									datahtml+='<a href="#" class="button [radius round] red" style="background-color: '+operationitem['color']+';border: 1px solid '+operationitem['color']+';" onclick="operation(\''+operationitem['no']+'\','+ordersitem['order_id']+')">'+operationitem['name']+'</a>';
								}
								console.log(operationitem['no']);
							}
							datahtml+='</div></div>';
	        			}
        			}

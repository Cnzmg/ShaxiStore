<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:39:"template/platform/Config/payConfig.html";i:1581654357;s:27:"template/platform/base.html";i:1581654383;s:44:"template/platform/controlCommonVariable.html";i:1581654383;s:33:"template/platform/openDialog.html";i:1581654383;}*/ ?>
<!DOCTYPE html>
					...
					<div class="panel-body">
						<form class="form-horizontal" id="wpay_form"  method="post">
							<div class="form-group">
								...
								<div class="col-md-4">
									<label class="switch">
										<input type="checkbox" id="wpay_is_use" <?php if($config['is_use']==1): ?> checked="checked"<?php endif; ?>>
										<span></span>
									</label>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-4">
									<input type="text" class="form-control" id="APP_KEY" name="APP_KEY" required
										value="<?php echo $config['value']['appid']; ?>">
								</div>
							...
							<div class="form-group">
								...
								<div class="col-md-4">
									<input type="text" class="form-control" id="APP_SECRET" name="APP_SECRET"  required
										value="<?php echo $config['value']['appkey']; ?>">
								</div>
							...
							<div class="form-group">
								...
								<div class="col-md-4">
									<input type="text" class="form-control" id="paySignKey" name="paySignKey" required
										value="<?php echo $config['value']['mch_key']; ?>">
								</div>
							...
							<div class="form-group">
								...
								<div class="col-md-4">
									<input type="text" class="form-control" id="MCHID" name="MCHID" required
										value="<?php echo $config['value']['mch_id']; ?>">
								</div>
...
<!-- 								<div class="col-md-4"> -->
<!-- 									<label class="switch"> -->
<!-- 										<input type="checkbox" id="alipay_is_use" <?php if($ali_config['is_use'] == 1): ?>checked<?php endif; ?>> -->
<!-- 										<span></span> -->
<!-- 									</label> -->
<!-- 								</div> -->
<!-- 							</div> -->
...
<!-- 										value="<?php echo $ali_config['oauth_value']['ali_partnerid']; ?>"> -->
<!-- 								</div> -->
...
<!-- 										value="<?php echo $ali_config['oauth_value']['ali_seller']; ?>"> -->
<!-- 								</div> -->
...
<!-- 										value="<?php echo $ali_config['oauth_value']['ali_key']; ?>"> -->
<!-- 								</div> -->

<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:40:"template/platform/Auth/addAuthGroup.html";i:1579055901;s:27:"template/platform/base.html";i:1579055862;s:44:"template/platform/controlCommonVariable.html";i:1579055862;s:33:"template/platform/openDialog.html";i:1579055862;}*/ ?>
<!DOCTYPE html>
			...
			<div class="form-group level_0">
				...
				<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $key=>$v1): ?>
					<div class="form-group level_1">
						<div class="col-md-1">
							<label class="checkbox-inline"> <input type="checkbox" dir="0" onclick="selectlevel('level_1', this)" name="module_id" value="<?php echo $v1['module_id']; ?>"> <b style="color:#555;"><?php echo $v1['module_name']; ?></b></label>
						</div>
						<div class="col-md-11">
							...
							<div class="form-group level_2">
								<div class="col-md-2">
									<label class="checkbox-inline"> <input type="checkbox" dir="<?php echo $v2['pid']; ?>" onclick="selectlevel('level_2',this)" name="module_id" value="<?php echo $v2['module_id']; ?>"> <b><?php echo $v2['module_name']; ?></b></label>
								</div>
								<div class="col-md-10">
									<?php if(is_array($v2['child']) || $v2['child'] instanceof \think\Collection || $v2['child'] instanceof \think\Paginator): if( count($v2['child'])==0 ) : echo "" ;else: foreach($v2['child'] as $key=>$v3): ?>
										<label class="checkbox-inline"> <input type="checkbox" parentdir="<?php echo $v2['pid']; ?>" dir="<?php echo $v3['pid']; ?>" onclick="selectlevel('level_3',this)" name="module_id" value="<?php echo $v3['module_id']; ?>"> <?php echo $v3['module_name']; ?></label>
									<?php endforeach; endif; else: echo "" ;endif; ?>
								</div>
							</div>
							<?php endforeach; endif; else: echo "" ;endif; ?>
...
function selectlevel(level, event){
	...
	function addAuthGroupAjax() {
		...
		$.ajax({
			type : "post",
			url : "PLATFORM_MAIN/Auth/addAuthGroup",
			data : {
			...
			success : function(data) {
				if (data['code'] > 0) {
					showMessage('success', "添加成功",'PLATFORM_MAIN/Auth/authGroupList');
				}else{

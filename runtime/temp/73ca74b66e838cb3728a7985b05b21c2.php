<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:46:"template/wap/default//Member/personalData.html";i:1581654516;s:30:"template/wap/default/base.html";i:1581654581;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<form class="mt-55 mlr-15" id="edit" style="display: none;margin:45px 0 0 0;width:100%;">
	<div class="threeBind">
		<ul>
			...
			<?php if($qq_openid != ''): ?>
			<li><img src="__TEMP__/<?php echo $style; ?>/public/images/personalData_qq.png" alt="" /><a href="APP_MAIN/member/removebindqq"><span>QQ</span> <div><span class="">解除绑定</span><span class="right_border">&nbsp;</span></div></a> </li>
			<?php else: ?>
			<li><img src="__TEMP__/<?php echo $style; ?>/public/images/personalData_qq.png" alt="" /><a href="APP_MAIN/login/oauthlogin?type=QQLOGIN"><span>QQ</span> <div><span class="wei_span">未绑定</span><span class="right_border">&nbsp;</span></div></a> </li>
...
<form class="mt-55 mlr-15" id="edit_mobile" style="display: none;background-color:#fff;margin-top: 10px;margin:0;    margin-top: 8px;" >
		<div>
			<span>手机号</span>
			<input type="text" id="mobile"  placeholder="请输入手机号码"  value='<?php echo $member_info['user_info']['user_tel']; ?>'/>
...
<form class="mt-55 mlr-15" id="edit_email" style="display: none;background-color:#fff;margin-top: 10px;margin:0;margin-top: 8px;">
		<div><span>邮箱</span>
			<input type="text" id="email"  placeholder="请输入邮箱"  value='<?php echo $member_info['user_info']['user_email']; ?>'/>
		</div>
		<?php if($login_verify_code['pc'] == 1): ?>
		<div>
			<span>验证码</span>

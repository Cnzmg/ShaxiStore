<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:42:"template/admin/Goods/updateGoodsGroup.html";i:1581654294;s:24:"template/admin/base.html";i:1581654310;s:41:"template/admin/controlCommonVariable.html";i:1581654310;s:30:"template/admin/pageCommon.html";i:1581654310;s:30:"template/admin/openDialog.html";i:1581654310;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<div class="set-style">
	<input name="UserCode" id="group_id" type="hidden" value="<?php echo $data['group_id']; ?>">
	<dl>
		<dt><span class="color-red">*</span>商品分组名称:</dt>
		<dd>
			<p><input name="UserCode" id="group_name" type="text" value="<?php echo $data['group_name']; ?>"> </p>
			<p class="error">请输入商品分组名称</p>
		</dd>
	</dl>
<!-- 	<dl> -->
<!-- 		<dt>上级分组:</dt> -->
...
<!-- 				<?php if(!(empty($group_list) || (($group_list instanceof \think\Collection || $group_list instanceof \think\Paginator ) && $group_list->isEmpty()))): ?> -->
<!-- 					<?php if(is_array($group_list) || $group_list instanceof \think\Collection || $group_list instanceof \think\Paginator): if( count($group_list)==0 ) : echo "" ;else: foreach($group_list as $key=>$v1): ?> -->
<!-- 					<option value="<?php echo $v1['group_id']; ?>" <?php if($data['pid'] == $v1['group_id']): ?>selected<?php endif; ?>>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $v1['group_name']; ?></option> -->
<!-- 					<?php endforeach; endif; else: echo "" ;endif; ?> -->
<!-- 				<?php endif; ?> -->
<!-- 			</select> -->
<!-- 		</dd> -->
...
<!-- 		<dd> -->
<!-- 			<p> -->
<!-- 				<input id="is_visible" type="checkbox" class="checkbox" <?php if($data['is_visible'] == 1): ?>checked="checked"<?php endif; ?>/> -->
...
<!-- 	</dl> -->
	<dl>
		<dt>排序:</dt>
		<dd>
			<p><input name="UserCode" id="sort" type="text"value="<?php echo $data['sort']; ?>"></p>
	...
	<dl>
		<dt>分组图片:</dt>
		<dd>
			<div class="class-logo"><p><img id="imgLogo2"src="__ROOT__/<?php echo $data['group_pic']; ?>" ></p></div>
			<div class="ncsc-upload-btn"> 
			    <a href="javascript:void(0);"><span>
			        ...
			        <input type="hidden"id="Logo2"value="<?php echo $data['group_pic']; ?>"/></span><p><!-- <i class="icon-upload-alt"></i> -->上传图片</p>
			    </a> 
			</div>
...
<script src="ADMIN_JS/goods/goods_group_edit.js"></script>

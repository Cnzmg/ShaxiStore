<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:44:"template/platform/Wchat/messageTemplate.html";i:1581654382;s:27:"template/platform/base.html";i:1581654383;s:44:"template/platform/controlCommonVariable.html";i:1581654383;s:33:"template/platform/openDialog.html";i:1581654383;}*/ ?>
<!DOCTYPE html>
...
<div class="server-msg content">
	...
	<table class="table header-bgf7" border="1">
		<colgroup>
			<col style="width: 20%">
			<col style="width: 20%">
			<col style="width: 30%">
		...
		<tbody id="grouplis">
			<?php if(is_array($message) || $message instanceof \think\Collection || $message instanceof \think\Paginator): if( count($message)==0 ) : echo "" ;else: foreach($message as $key=>$info): ?>
			<tr name="li">
	...
	<p class="button">
		<button class="btn btn-large btn-primary" type="button"
			onclick="GetTemplateID(this)">获取</button>
	</p>
</div>

<?php if (!defined('THINK_PATH')) exit(); /*a:9:{s:50:"template/admin/Goods/selectCategoryNextUpdate.html";i:1581654293;s:24:"template/admin/base.html";i:1581654310;s:41:"template/admin/controlCommonVariable.html";i:1581654310;s:57:"template/admin/Goods/controlEditGoodsCommonResources.html";i:1581654292;s:38:"template/admin/Goods/fileAlbumImg.html";i:1581654292;s:52:"template/admin/Goods/controlEditGoodsCommonHTML.html";i:1581654292;s:54:"template/admin/Goods/controlEditGoodsCommonScript.html";i:1581654292;s:30:"template/admin/pageCommon.html";i:1581654310;s:30:"template/admin/openDialog.html";i:1581654310;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
	...
	<dl>
		...
		<dd>
			<div class="controls">
				...
				<label class="radio inline normal"><input type="radio" name="shelves" value="2" /> 放入仓库</label>
				<?php else: ?>
				<label class="radio inline normal"><input type="radio" name="shelves" value="1" /> 立刻上架</label>
				<label class="radio inline normal"><input type="radio" name="shelves" value="2" checked="checked" /> 放入仓库</label>
				<?php endif; ?>
			</div>
		</dd>
	</dl>
...
<div class="btn-submit">
    <input type="hidden" name="goods_state" value="<?php echo $goods_info['state']; ?>">
    <input type="hidden" name="is_use" value="<?php echo $goods_config_info['is_use']; ?>">

<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:44:"template/platform/Config/expressMessage.html";i:1581654354;s:27:"template/platform/base.html";i:1581654383;s:44:"template/platform/controlCommonVariable.html";i:1581654383;s:33:"template/platform/openDialog.html";i:1581654383;}*/ ?>
<!DOCTYPE html>
	...
	<div class="panel-body">
		<form class="form-horizontal">
			...
			<div class="form-group">
				...
				<div class="col-md-4" style="width:80%;">
					<input type="text" class="form-control" id=appid value="<?php echo $emconfig['value']['appid']; ?>" style="width:30%;">
				</div>
			...
			<div class="form-group">
				...
				<div class="col-md-4" style="width:80%;">
					<input type="text" class="form-control" id="appkey" value="<?php echo $emconfig['value']['appkey']; ?>" style="width:30%;">
				</div>
			...
			<div class="form-group">
				...
				<div class="col-md-4" style="width:80%;">
					<label class="radio inline"><input type="radio" name="is_use" value="1" <?php if($emconfig['is_use'] == 1): ?>checked="checked"<?php endif; ?>>是</label> 
					<label class="radio inline"><input type="radio" name="is_use" value="0" <?php if($emconfig['is_use'] == 0): ?>checked="checked"<?php endif; ?>>否</label>
				</div>
			</div>
			<div class="line line-dashed line-lg pull-in"></div>
			<div class="form-group">

<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:40:"template/platform/Config/userNotice.html";i:1581654358;s:27:"template/platform/base.html";i:1581654383;s:44:"template/platform/controlCommonVariable.html";i:1581654383;s:33:"template/platform/openDialog.html";i:1581654383;}*/ ?>
<!DOCTYPE html>
...
<section class="panel panel-default">
	<header class="panel-heading font-bold"> 用户通知 </header>
	<div class="panel-body">
		<form class="form-horizontal">
			<div class="form-group">
				<label class="col-sm-2 control-label">用户通知</label>
                                            <div class="col-sm-4">
                                                <div id="editor" class="form-control" style="overflow:scroll;height:150px;max-height:150px"><?php echo $user_notice; ?></div>
                                            </div>
			</div>
			<div class="line line-dashed line-lg pull-in"></div>
			<div class="form-group">
				<div class="col-sm-4 col-sm-offset-2">
					<a href="javascript:void(0);" onclick="setUserNoticeAjax()"
...
<script>	
	...
	*添加广告位
	*/
	function setUserNoticeAjax() {
		var user_notice = $("#editor").html();
		$.ajax({
			type : "post",
			url : "PLATFORM_MAIN/config/usernotice",
			data : {
			...
			success : function(data) {
				if (data["code"] > 0) {
					showMessage('success', "设置成功",'PLATFORM_MAIN/Config/usernotice');
				}else{

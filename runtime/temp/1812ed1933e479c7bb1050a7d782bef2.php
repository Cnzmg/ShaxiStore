<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:42:"template/platform/Goods/addGoodsBrand.html";i:1581654364;s:27:"template/platform/base.html";i:1581654383;s:44:"template/platform/controlCommonVariable.html";i:1581654383;s:33:"template/platform/openDialog.html";i:1581654383;}*/ ?>
<!DOCTYPE html>
...
<section class="panel panel-default">
	<header class="panel-heading font-bold"> 添加品牌 </header>
	<div class="panel-body">
		<form class="form-horizontal" id="goods_brand_form" name="form">
            ...
            <div class="form-group">
				...
				<div class="col-md-4">
					<label class="switch">
                                                    <input id="brand_recommend" type="checkbox" >
                                                    <span></span> </label>
				</div>
			</div>
            <div class="line line-dashed line-lg pull-in"></div>
            ...
            <div class="form-group">
				...
				<div class="col-md-10">
					<p><img id="imgLogo1" src="" class="imglogo"/></p>
                                            	<a href="javascript:void(0);" style="display:block;position:relative;z-index:1;">
                                            		<span style="width: 97px;height: 34px;position: absolute;left: 0;top: 0;z-index: 2;cursor: pointer;"> 
                                            		<input hidefocus="true" size="1" class="input-file" name="file_upload"
...
function changeCategory(type){
	...
	function addGoodsBrandAjax(){
		...
		$.ajax({
			type:"post",
			url:"PLATFORM_MAIN/goods/addgoodsbrand",
			data:{
			...
			success:function (data) {
				if (data["code"] > 0) {
					showMessage('success', "商品品牌添加成功",'PLATFORM_MAIN/goods/goodsbrandlist');
				}else{
					showMessage('error', "商品品牌添加失败");
				}
			}
		});
	}

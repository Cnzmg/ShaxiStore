<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:37:"template/admin/System/moduleList.html";i:1581654306;s:24:"template/admin/base.html";i:1581654310;s:41:"template/admin/controlCommonVariable.html";i:1581654310;s:30:"template/admin/pageCommon.html";i:1581654310;s:30:"template/admin/openDialog.html";i:1581654310;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		...
		<tr class="pid_0" style="height: 30px;">
			...
			<td style="text-align: center;"><input onkeyup="value=value.replace(/[^\d+(\.\d+)?]/g,'')" type="text" class="sort"
				...
				<td style="text-align: center;"><a
					href="ADMIN_MAIN/system/editmodule?module_id=<?php echo $v1['module_id']; ?>">修改</a>
			...
			<tr class="pid_<?php echo $v1['module_id']; ?>"
				...
				<td style="text-align: center;"><a
					href="ADMIN_MAIN/system/editmodule?module_id=<?php echo $v2['module_id']; ?>">修改</a>
					<a href="javascript:void(0);"
			...
			<tr class="pid_<?php echo $v2['module_id']; ?> pid_<?php echo $v1['module_id']; ?>"
				...
				<td style="text-align: center;"><a
					href="ADMIN_MAIN/system/editmodule?module_id=<?php echo $v3['module_id']; ?>">修改</a>
					<a href="javascript:void(0);"
			...
			<tr
				...
				<td style="text-align: center;"><a
					href="ADMIN_MAIN/system/editmodule?module_id=<?php echo $v4['module_id']; ?>">修改</a>
					<a href="javascript:void(0);"
			...
			<tr
				...
				<td style="text-align: center;"><a
					href="ADMIN_MAIN/system/editmodule?module_id=<?php echo $v5['module_id']; ?>">修改</a>
					<a href="javascript:void(0);"
...
$(".style0list table input").change(function(){
	...
	function tab_switch(module_id){
		...
		function addModule(){
			var pid = $("#pid").val();
			location.href = "ADMIN_MAIN/system/addmodule?pid="+pid;
		}
	                ...
	                "确定": function() {
	                    ...
	                    $.ajax({
	        				...
	        				success:function (data) {
	        					...
	        					if(data['code'] > 0){
	        						location.href = "ADMIN_MAIN/system/modulelist";
	        					}else{
	        						$("#dialog").dialog({
	        							 buttons: {
	        					                "确定": function() {

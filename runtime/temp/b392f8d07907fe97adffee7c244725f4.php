<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:34:"template/platform/Login/login.html";i:1581654369;s:33:"template/platform/openDialog.html";i:1581654383;}*/ ?>
...
function login() {
	...
	$.ajax({
		...
		success : function(data) {
			if (data["code"] > 0) {
				$(".fadeInLefts").hide();
				location.href = "PLATFORM_MAIN/Index/index";
			}else{

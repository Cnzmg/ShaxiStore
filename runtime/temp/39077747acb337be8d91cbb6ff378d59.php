<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:35:"template/platform/Auth/addUser.html";i:1579055901;s:27:"template/platform/base.html";i:1579055862;s:44:"template/platform/controlCommonVariable.html";i:1579055862;s:33:"template/platform/openDialog.html";i:1579055862;}*/ ?>
<!DOCTYPE html>
...
// 		verify(admin_name, user_password, desc);
		$.ajax({
			type : "post",
			url : "PLATFORM_MAIN/Auth/addUser",
			data : {
			...
			success : function(data) {
				if (data['code'] > 0) {
					location.href = 'PLATFORM_MAIN/Auth/userList';
				}
			}
		});
	}

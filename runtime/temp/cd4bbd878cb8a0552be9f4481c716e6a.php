<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:47:"template/admin/Express/freightTemplateList.html";i:1581654290;s:24:"template/admin/base.html";i:1581654310;s:41:"template/admin/controlCommonVariable.html";i:1581654310;s:30:"template/admin/pageCommon.html";i:1581654310;s:30:"template/admin/openDialog.html";i:1581654310;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<li><a class="nscs-table-handle_green" href="ADMIN_MAIN/express/freighttemplateedit?co_id=<?php echo $co_id; ?>" >添加模板</a></li>
...
function LoadingInfo(page_index){
	$.ajax({
		url: 'ADMIN_MAIN/express/freighttemplatelist',
		type: 'POST',
		dataType: 'html',
	...
	$( "#dialog" ).dialog({
		buttons: {
			"确定": function() {
				...
				$.ajax({
					type:"post",
					url : "ADMIN_MAIN/express/freighttemplatedelete",

<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:40:"template/platform/Report/reportList.html";i:1581654375;s:27:"template/platform/base.html";i:1581654383;s:44:"template/platform/controlCommonVariable.html";i:1581654383;s:27:"template/platform/page.html";i:1581654384;s:33:"template/platform/openDialog.html";i:1581654383;}*/ ?>
<!DOCTYPE html>
...
$(function(){
	...
	{
		var inform_state ="<?php echo $inform_state; ?>";
            ...
            buttons: {
                "确定": function() {
                    ...
                    $.ajax({
            			...
            			success : function(data) {
            				if(data["code"] > 0 ){
            					showMessage('success', "删除成功",'<?php echo url(""); ?>');
            				}else{

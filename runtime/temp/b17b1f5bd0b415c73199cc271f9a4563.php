<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:42:"template/platform/Config/searchConfig.html";i:1581654358;s:27:"template/platform/base.html";i:1581654383;s:44:"template/platform/controlCommonVariable.html";i:1581654383;s:33:"template/platform/openDialog.html";i:1581654383;}*/ ?>
<!DOCTYPE html>
					...
					<div class="panel-body">
						<form class="form-horizontal">
							<div class="form-group">
								...
								<div class="col-md-4">
									<div id="editor" class="form-control" style="overflow: scroll; height: 150px; max-height: 150px"><?php echo $hot_keywords; ?></div><br/>
							...
							<div class="form-group">
								...
								<div class="col-md-4">
									<input type="text" class="form-control" id="default_keywords"
										value="<?php echo $default_keywords; ?>">
								</div>
								<div class="col-md-6">
...
<script>
	function setHotSearchAjax(){
		...
		$.ajax({
			type:"post",
			url:"PLATFORM_MAIN/config/hotsearchconfig",
			data:{
				'keywords':keywords
			},
			async:true,
			success:function (data) {
				if (data["code"] > 0) {
					showMessage('success', data["message"],"PLATFORM_MAIN/config/searchconfig");
				}else{
	...
	function defaultHotSearchAjax(){
		...
		$.ajax({
			type:"post",
			url:"PLATFORM_MAIN/config/defaultsearchconfig",
			data:{

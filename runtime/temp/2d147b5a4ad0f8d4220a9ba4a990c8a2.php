<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:31:"template/admin/Login/login.html";i:1581654295;}*/ ?>
...
<body>
	...
	<div class="header_min_top">
		...
		<div class="itopr font_gray9 link_gray6 substring">
			<a href="SHOP_MAIN/index" class="home">网站首页</a><!-- |
...
<div class="user_head_bg">
	<div class="user_head">
		<div class="logobox"><a href="SHOP_MAIN/index"><img src="__ROOT__/<?php echo $logo; ?>" border="0"></a></div>
...
<!-- 					</div> -->
					...
					<div class="qqbox">
						...
						<div class="appsparent" style="display: inline-block; float: right;margin-top: -55px;margin-right: 18px;">
							<div class="apps">
								<?php if($qq_info['is_use'] == 1): ?><a class="ali qq" href="APP_MAIN/login/oauthlogin?type=QQLOGIN" title="腾讯QQ账号登录"></a><?php endif; if($Wchat_info['is_use'] == 1): ?><a class="ali taobao" href="APP_MAIN/login/oauthlogin?type=WCHAT" title="微信登录"></a><?php endif; ?>
							</div>
						</div>
						<div class="clear"></div>
					</div>
...
<div class="footer_min" id="footer">
	<div class="links link_gray6">
		<a target="_blank" href="http://www.uin8.com/">网站首页</a>|
		<a target="_blank" href="http://www.uin8.com/">招贤纳士</a>|
		<a target="_blank" href="http://www.uin8.com/">联系我们</a>|
		<a target="_blank" href="http://www.uin8.com/">推广合作</a>|
		<a target="_blank" href="http://www.uin8.com/">法律申明</a>|
		<a target="_blank" href="http://www.uin8.com/">产品服务</a>|
		<a target="_blank" href="http://www.uin8.com/">网站介绍</a>|
		<a target="_blank" href="http://www.uin8.com/">意见建议</a> 
	</div>
	<div class="txt">
		<p>Copyright © 2015-2025 &nbsp;版权所有 保留一切权利
		<!-- <br><a href="http://www.uin8.com/" target="_blank" style="text-decoration: none;color:#333333;">山西牛酷信息科技有限公司&nbsp;提供技术支持</a>

<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:48:"template/wap/default//Member/memberIndexB2C.html";i:1581654515;s:30:"template/wap/default/base.html";i:1581654581;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="panel memberhead">
	<div class="member_head">
		<a href="APP_MAIN/member/personaldata?shop_id=<?php echo $shop_id; ?>">
		...
		<div style="overflow: hidden;width: 100%;">
			<a href='APP_MAIN/member/balancewater?shop_id=<?php echo $shop_id; ?>' class="member-info" style="width:49.5%;">
			...
			<a href='APP_MAIN/member/integral' class="member-info" style="float:right;width:49.5%;"><span >积分&nbsp;</span><span ><?php echo $member_info['point']; ?></span></a>
		 </div>
	</div>
</div>
<div class="control">
	...
	<div class="control_r"><a href="APP_MAIN/order/myorderlist?shop_id=<?php echo $shop_id; ?>" class="right_href">查看全部订单</a></div>
</div>

<div class="panel member-nav" >
	<ul class="fu clear" >
		<li class="last" >
			<a href="APP_MAIN/order/myorderlist?status=0&shop_id=<?php echo $shop_id; ?>">
				<img src="__TEMP__/<?php echo $style; ?>/public/images/pay.png">
				<p>待付款</p>
			</a>
		</li>
		<li class="last">
			<a href="APP_MAIN/order/myorderlist?status=1&shop_id=<?php echo $shop_id; ?>">
				<img src="__TEMP__/<?php echo $style; ?>/public/images/send.png">
				<p>待发货</p>
			</a>
		</li>
		<li class="last">
			<a href="APP_MAIN/order/myorderlist?status=2&shop_id=<?php echo $shop_id; ?>">
				<img src="__TEMP__/<?php echo $style; ?>/public/images/recieve.png">
				<p>待收货</p>
			</a>
		</li>
		<li class="last">
			<a href="APP_MAIN/order/myorderlist?status=3&shop_id=<?php echo $shop_id; ?>">
				<img src="__TEMP__/<?php echo $style; ?>/public/images/recieved.png">
				<p>已收货</p>
			</a>
		</li>
		<li class="last">
			<a href="APP_MAIN/order/myorderlist?status=4&shop_id=<?php echo $shop_id; ?>">

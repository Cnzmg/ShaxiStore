<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:46:"template/platform/Config/registerAndVisit.html";i:1581654357;s:27:"template/platform/base.html";i:1581654383;s:44:"template/platform/controlCommonVariable.html";i:1581654383;s:33:"template/platform/openDialog.html";i:1581654383;}*/ ?>
<!DOCTYPE html>
	...
	<div class="panel-body">
		<form class="form-horizontal">
			...
			<div class="form-group">
				...
				<div class="col-md-8">
					<textarea  rows="2" id="name_keyword"  class="form-control" style="width:400px;height:100px;" maxlength="50"><?php echo $register_and_visit["name_keyword"]; ?></textarea>
			...
			<div class="form-group">
				...
				<div class="col-md-4">
						 <input id="pwd_len" type="number" min="0" step="1" class="form-control" value="<?php echo $register_and_visit['pwd_len']; ?>"/> 
			...
			<div style="display:none;">
				...
				<div class="col-md-4">
					<textarea  rows="2" id="terms_of_service"
						class="textarea w400" maxlength="50"><?php echo $register_and_visit["terms_of_service"]; ?></textarea>

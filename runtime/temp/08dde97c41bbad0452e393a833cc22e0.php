<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:38:"template/platform/Goods/goodsList.html";i:1581654366;s:27:"template/platform/base.html";i:1581654383;s:44:"template/platform/controlCommonVariable.html";i:1581654383;s:27:"template/platform/page.html";i:1581654384;s:33:"template/platform/openDialog.html";i:1581654383;}*/ ?>
<!DOCTYPE html>
        ...
        $( "#dialog" ).dialog({
            buttons: {
                "确定": function() {
                    ...
                    $.ajax({
                        type : "post",
                        url : "PLATFORM_MAIN/Goods/ModifyGoodsExam",
                        async : true,
                        data : {
                            "goods_ids" : goods_ids
                        },
                        success : function(data) {
                            if(data["code"] > 0 ){
                                showMessage('success', "通过成功",'PLATFORM_MAIN/Goods/goodsList');
                            }else{

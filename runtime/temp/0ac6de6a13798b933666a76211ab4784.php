...
<div class="row padder-v">
		...
		<div class="col-sm-5">
				<a
					class="btn btn-sm btn-default <?php if($type == '0'): ?>active<?php endif; ?>"
					href="PLATFORM_MAIN/Wchat/materialmessage?type=0">全部</a> <a
					class="btn btn-sm btn-default <?php if($type == '1'): ?>active<?php endif; ?>"
					href="PLATFORM_MAIN/Wchat/materialmessage?type=1">文本</a> <a
					class="btn btn-sm btn-default <?php if($type == '2'): ?>active<?php endif; ?>"
					href="PLATFORM_MAIN/Wchat/materialmessage?type=2">单图文</a> <a
					class="btn btn-sm btn-default <?php if($type == '3'): ?>active<?php endif; ?>"

<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:35:"template/shop/blue/Login/login.html";i:1579055856;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="user_head_bg">
	<div class="user_head">
		<div class="logobox" style="padding-top:20px;"><a href="SHOP_MAIN"><img src="__UPLOAD__/<?php echo $web_info['logo']; ?>" border="0" style="width:200px;"></a></div>
		<div class="reg">
			<span style="float:right;">
				<span>没有账号？</span>
				<a href="SHOP_MAIN/login/registerbox" style="color:white; text-decoration: none;line-height: 40px;">
...
<!-- 				<?php endif; ?> -->
				<div class="tit">
					<span class="switch_txt active"><?php echo $title; ?>用户登录</span>
...
<!-- 						<div class="imgbg"></div> -->
						<input type="text" id="vertification" class="input_login vertification" name="vertification" placeholder="请输入验证码 " style="padding-left:15px;width:285px;" /> 
					...
					<div class="txtbox link_gray6">
						...
						<div class="td2" style="float: right;text-align: left;"><a href="SHOP_MAIN/login/findpasswd">忘记密码?</a></div>
					</div>
					...
					<div class="qqbox">
						...
						<div class="appsparent" style="display: inline-block; float: right;margin-top: -55px;margin-right: 18px;">
							<div class="apps">
							<?php if($qq_info['is_use'] == 1): ?><a class="ali qq" href="APP_MAIN/login/oauthlogin?type=QQLOGIN" title="腾讯QQ账号登录"></a><?php endif; if($Wchat_info['is_use'] == 1): ?><a class="ali taobao" href="APP_MAIN/login/oauthlogin?type=WCHAT"  title="微信授权登录"></a><?php endif; ?>
							</div>
						</div>
						<div class="clear"></div>
					</div>
...
<div class="footer_min" id="footer">
	<div class="links link_gray6">
		<a target="_blank" href="SHOP_MAIN/index/index">网站首页</a>|
		<a target="_blank" href="SHOP_MAIN/helpcenter/index?id=2">常见问题</a>|
		<a target="_blank" href="SHOP_MAIN/helpcenter/index?id=1">购物流程</a>|
		<a target="_blank" href="SHOP_MAIN/helpcenter/index?id=9">退款说明</a>|
		<a target="_blank" href="http://www.5law.cn/">法律申明</a>|
		<a target="_blank" href="SHOP_MAIN/helpcenter/index?id=10">退款流程</a>|
		<a target="_blank" href="SHOP_MAIN/helpcenter/index?id=12">商家入驻</a>|
		<a target="_blank" href="SHOP_MAIN/helpcenter/index?id=11">退款政策</a> 
	</div>
	<div class="txt">
		<p>
			<span>Copyright © 2015-2025 Niushop开源商城&nbsp;版权所有 保留一切权利</span>
			<br/>
			<a href="http://www.niushop.com.cn" target="_blank">山西牛酷信息科技有限公司&nbsp;提供技术支持</a>
			<span>400-886-7993</span>
		</p>
	</div>
</div>
<!--[if lt IE 9]>
...
function btnlogin() {
	...
	$.post("SHOP_MAIN/login/index", {
		...
		if (data['code'] == 1) {
			...
			window.location.href ="SHOP_MAIN/index/index";
		}else {
			$("#hint").css("display", "block");

<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:36:"template/platform/Auth/editUser.html";i:1581654347;s:27:"template/platform/base.html";i:1581654383;s:44:"template/platform/controlCommonVariable.html";i:1581654383;s:33:"template/platform/openDialog.html";i:1581654383;}*/ ?>
<!DOCTYPE html>
	...
	<div class="panel-body">
		<form class="form-horizontal"  id="user_form" name="form">
			<div class="form-group">
				...
				<div class="col-md-2">
					<input type="text" class="form-control" id="admin_name" name="admin_name" value="<?php echo $ua_info['admin_name']; ?>" required>
				</div>
				...
				<div class="col-sm-2">
					<select id="group_id" name="group_id" class="form-control m-b" required>
						...
						<?php if(is_array($auth_group) || $auth_group instanceof \think\Collection || $auth_group instanceof \think\Paginator): if( count($auth_group)==0 ) : echo "" ;else: foreach($auth_group as $key=>$v1): ?>
							<option value="<?php echo $v1['group_id']; ?>" <?php if($v1['group_id'] == $ua_info['group_id_array']): ?>selected<?php endif; ?>>&nbsp;&nbsp;<?php echo $v1['group_name']; ?></option>
						<?php endforeach; endif; else: echo "" ;endif; ?>
					</select>
				</div>
			...
			<div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <div id="editor" class="form-control" style="overflow:scroll;height:150px;max-height:150px"><?php echo $ua_info['desc']; ?></div>
                                            </div>
                                        </div>
			<div class="line line-dashed line-lg pull-in"></div>
			<div class="form-group">
				<div class="col-sm-4 col-sm-offset-2">
					<input type="hidden" id="uid" value="<?php echo $ua_info['uid']; ?>">
...
$().ready(function() {
	...
	*/	
	function editUserAjax() {
			...
			$.ajax({
				type : "post",
				url : "PLATFORM_MAIN/Auth/editUser",
				data : {
					'uid' : uid,

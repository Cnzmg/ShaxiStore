<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:34:"template/admin/Shop/sinceList.html";i:1581654304;s:24:"template/admin/base.html";i:1581654310;s:41:"template/admin/controlCommonVariable.html";i:1581654310;s:30:"template/admin/pageCommon.html";i:1581654310;s:30:"template/admin/openDialog.html";i:1581654310;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<li><a class="nscs-table-handle_green" href="ADMIN_MAIN/shop/addpickuppoint" ><i class="fa fa-plus-circle"></i>&nbsp;添加自提点</a></li>
...
function LoadingInfo(page_index) {
	...
	$.ajax({
		type : "post",
		url : "ADMIN_MAIN/shop/pickuppointlist",
		async : true,
		data : {
		...
		success : function(data) {
			...
			if (data["data"].length > 0) {
				for (var i = 0; i < data["data"].length; i++) {
					...
					html += '<td><a href="ADMIN_MAIN/shop/updatepickuppoint?id='+ data['data'][i]['id']+'">修改</a><a style="cursor: pointer;" onclick="deletepickupPoint('+data['data'][i]['id']+')">删除</a></td> ';
					html += '</tr>';
				}
			} else {
		...
		buttons: {
			"确定": function() {
				...
				if(!flag){
					...
					$.ajax({
						type : "post",
						url : "ADMIN_MAIN/shop/deletepickuppoint",
						data : {
						...
						success : function(data) {
							if (data["code"] > 0) {
								...
								window.location.href="ADMIN_MAIN/shop/pickuppointlist";
							}else{

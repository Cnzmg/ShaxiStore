<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:42:"template/platform/Config/updatenotice.html";i:1581654358;s:27:"template/platform/base.html";i:1581654383;s:44:"template/platform/controlCommonVariable.html";i:1581654383;s:33:"template/platform/openDialog.html";i:1581654383;}*/ ?>
<!DOCTYPE html>
	...
	<div class="panel-body">
		<form class="form-horizontal">
			<div class="form-group">
                ...
                <div class="col-sm-4">
                    <textarea id="notice_message" class="form-control" style="overflow:scroll;height:150px;max-height:150px"><?php echo $info['notice_message']; ?></textarea>
                </div><br/>
		...
		<!-- 		<div style="margin-top: 7px;">
				...
				<label class="switch">
                        <input id="is_enable" type="checkbox"  <?php if($info['is_enable']==1): ?> checked="checked"<?php endif; ?>>
                        <span></span> 
                </label>
			</div>

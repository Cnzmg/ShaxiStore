<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:42:"template/platform/Statistics/userStat.html";i:1581654379;s:27:"template/platform/base.html";i:1581654383;s:44:"template/platform/controlCommonVariable.html";i:1581654383;s:33:"template/platform/openDialog.html";i:1581654383;}*/ ?>
<!DOCTYPE html>
...
<!-- 					src="PLATFORM_IMG/logo1.png" class="m-r-sm"></a> -->
	...
	<!-- 			<li class="hidden-xs">
		...
		<div id="content" class="main">
            ...
            <div class="row">
              <div class="col-md-12">
               <p class="chairs-css">今日新增会员：<?php echo $user_today_num; ?>&nbsp;|&nbsp;本月新增会员：<?php echo $user_month_num; ?>&nbsp;|&nbsp;会员总数：<?php echo $user_count_num; ?></p>
                <section class="panel panel-default">
                  <header class="panel-heading font-bold">
                  新增会员
                  <div class="search-css">
                  	注册时间：
					<input type="text" id="startDate" class="input-medium" placeholder="请选择开始日期" onclick="WdatePicker()" value="<?php echo $start_date; ?>"/>
					&nbsp;-&nbsp;
					<input type="text" id="endDate" placeholder="请选择结束日期" class="input-medium" onclick="WdatePicker()"value="<?php echo $end_date; ?>" />

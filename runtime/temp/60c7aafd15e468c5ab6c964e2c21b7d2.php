<?php if (!defined('THINK_PATH')) exit(); /*a:21:{s:39:"template/shop/blue/Goods/goodsInfo.html";i:1581654389;s:28:"template/shop/blue/base.html";i:1581654443;s:45:"template/shop/blue/controlCommonVariable.html";i:1581654443;s:34:"template/shop/blue/controlTop.html";i:1581654444;s:41:"template/shop/blue/controlHeadSerach.html";i:1581654444;s:44:"template/shop/blue/controlHeadSearchAdv.html";i:1581654444;s:43:"template/shop/blue/controlHeadGoodType.html";i:1581654444;s:40:"template/shop/blue/controlCommonNav.html";i:1581654443;s:43:"template/shop/blue/controlRightSidebar.html";i:1581654444;s:44:"template/shop/blue/Goods/controlGallery.html";i:1581654387;s:46:"template/shop/blue/Goods/controlStoreInfo.html";i:1581654389;s:56:"template/shop/blue/Goods/controlStoreClassification.html";i:1581654389;s:46:"template/shop/blue/Goods/controlStoreRank.html";i:1581654389;s:49:"template/shop/blue/Goods/controlGoodEvaluate.html";i:1581654387;s:45:"template/shop/blue/controlCommonPageAjax.html";i:1581654443;s:55:"template/shop/blue/Goods/controlPurchaseConsulting.html";i:1581654388;s:50:"template/shop/blue/Goods/controlGoodsInfoData.html";i:1581654388;s:45:"template/shop/blue/controlBottomLinkHelp.html";i:1581654443;s:37:"template/shop/blue/controlBottom.html";i:1581654443;s:36:"template/shop/blue/controlLogin.html";i:1581654444;s:37:"template/shop/blue/baidu_js_push.html";i:1581654443;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div id="MagnifierWrap">
	<div class="MagnifierMain">
		<img class="MagTargetImg" src="__UPLOAD__/<?php echo $default_gallery_img; ?>" />
	</div>
	...
	<div class="spec-items">
		...
		<?php if(is_array($goods_info['img_list']) || $goods_info['img_list'] instanceof \think\Collection || $goods_info['img_list'] instanceof \think\Paginator): if( count($goods_info['img_list'])==0 ) : echo "" ;else: foreach($goods_info['img_list'] as $k=>$img): if($k==0): ?>
			...
			<li>
			<?php endif; ?>
			<img src="__UPLOAD__/<?php echo $img['pic_cover_big']; ?>" />
			</li>
		<?php endforeach; endif; else: echo "" ;endif; ?>
		</ul>
	</div>
			...
			<?php if(($is_llegral_inform == 0) and ($goods_info['state'] == 1)): ?>
				<a onclick="location.href='SHOP_MAIN/member/inform?goodsid=<?php echo $goods_info['goods_id']; ?>';" class="goods-compare compare-btn fr add-compare"><i></i> 举报</a>
			<?php endif; ?>	
			...
			<form action="" method="post" name="formBuyNow" id="formBuyNow">
				...
				<div class="goods-price">
					...
					<div class="show-price">
						...
						<font class="market-price">￥<?php echo $goods_info['price']; ?></font>
					</div>
...
<!-- 							</div> -->
				...
				<div class="choose js-skulist">
					...
					<input type="hidden" id="goods_sku<?php echo $k; ?>" value="<?php echo $pro_skus['attr_value_items']; ?>;" stock="<?php echo $pro_skus['stock']; ?>" <?php if($pro_skus['promote_price'] < $pro_skus['member_price']): ?>price="<?php echo $pro_skus['promote_price']; ?>" <?php else: ?>price="<?php echo $pro_skus['member_price']; ?>"<?php endif; ?> promotion_price="<?php echo $pro_skus['promote_price']; ?>" member_price="<?php echo $pro_skus['member_price']; ?>" skuid="<?php echo $pro_skus['sku_id']; ?>" skuname="<?php echo $pro_skus['sku_name']; ?>" original_price="<?php echo $pro_skus['price']; ?>" />
					...
					<dl class="amount">
						...
						<dd class="dd">
							<span class="amount-widget">
								<input type="text" class="amount-input" value="1"  data-max="<?php if($goods_info['max_buy']==0): ?><?php echo $goods_info['stock']; else: ?><?php echo $goods_info['max_buy']; endif; ?>" title="请输入购买量" id="num" />
...
<div class="store-info">
	<dl class="store-logo">
		<a href="SHOP_MAIN/shop/shopindex?shop_id=<?php echo $shop_info['shop_id']; ?>" target="_blank"> 
			<img src=" __UPLOAD__/<?php echo $shop_info['shop_avatar']; ?>" width="" height="">
		</a>
	</dl>
	<dl class="store-name third-store">
		<a href="SHOP_MAIN/shop/shopindex?shop_id=<?php echo $shop_info['shop_id']; ?>" target="_blank" class="name" title="<?php echo $shop_info['shop_company_name']; ?>"><?php echo $shop_info['shop_name']; ?></a>
		<input type="hidden" value="<?php echo $shop_info['shop_id']; ?>" id="store_shop_id"/>
	</dl>
	<dl class="store-score">
		<dd>
			<!-- 通过分数判断width的宽度-->
			<div class="score-sum color"><?php echo $shop_score; ?> <span>综合</span>
			</div>
			<ul class="score-part">
				<li>
					<span class="score-desc">描述相符</span>
					<span class="score-detail color"><?php echo $shop_info['shop_desccredit']; ?></span>
				</li>
				<li>
					<span class="score-desc">服务态度</span>
					<span class="score-detail color"><?php echo $shop_info['shop_servicecredit']; ?></span>
				</li>
				<li>
					<span class="score-desc">发货速度</span>
					<span class="score-detail color"><?php echo $shop_info['shop_deliverycredit']; ?></span>
				</li>
			</ul>
		</dd>
	</dl>
	<dl class="store-other">
		<dt>所在地：</dt>
		<dd><?php echo $shop_info['live_store_address']; ?></dd>
	</dl>
	<!-- 客服 -->
	<dl class="store-other">
		<dt class="tool">QQ客服：</dt>
		<dd class="tool">
			<a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=<?php echo $shop_info['shop_qq']; ?>&site=qq&menu=yes" class="service-btn service-online">
				<img src="__TEMP__/<?php echo $style; ?>/public/images/openim.png" width="20" height="20" border="0" alt="在线客服">
				<span>在线客服</span>
			</a>
		</dd>
	</dl>
	<div class="enter-store">
		<div class="enter-store-item">
			<a class="bg-color goto-shop"href="SHOP_MAIN/shop/shopindex?shop_id=<?php echo $shop_id; ?>" target="_blank"><i></i> 进入店铺</a>
			<a class="bg-color shop-add collect-shop" href="javascript:;"><i></i> 
				<span>
				<?php if($is_member_fav_shop==0||$is_member_fav_shop==-1): ?>
					收藏本店
				<?php else: ?>
					取消收藏
				<?php endif; ?>
...
<script>
var is_member_fav_shop = <?php echo $is_member_fav_shop; ?>;//获取商品收藏状态
// 添加收藏
	...
	if(uid!=null && uid!="")
	{
		...
		{	
			...
			$.ajax({
				...
				type: "post",
				data: { "fav_id":<?php echo $shop_info['shop_id']; ?>,"fav_type":"shop","log_msg":""},
				success: function (data) {
					if(data.code>0)
					{
			...
			$.ajax({
				...
				type: "post",
				data: { "fav_id":<?php echo $shop_info['shop_id']; ?>,"fav_type":"shop"},
				success: function (data) {
					if(data.code>0)
					{
			...
			<div class="j-tab-con">
				...
				<?php if(is_array($goods_rank) || $goods_rank instanceof \think\Collection || $goods_rank instanceof \think\Paginator): if( count($goods_rank)==0 ) : echo "" ;else: foreach($goods_rank as $k=>$goods): if(($k+1) <= 5): ?>
					<li class="goods-item first">
						<div class="picture">
							<a href="SHOP_MAIN/goods/goodsinfo?goodsid=<?php echo $goods['goods_id']; ?>" title="<?php echo $goods['goods_name']; ?>">
								<img src="__UPLOAD__/<?php echo $goods['pic_cover_mid']; ?>" />
							</a>
						</div>
						<div class="price">
							<a href="SHOP_MAIN/goods/goodsinfo?goodsid=<?php echo $goods['goods_id']; ?>" title="<?php echo $goods['goods_name']; ?>"><?php echo $goods['goods_name']; ?></a>
			...
			<div class="wrapper">
				<div id="main-nav-holder" class="goods-detail">
					<ul id="nav" class="tab">
						...
						<li class="title-list" data-index="3"><a id="evaluate_count" href="javascript:;">累计评价(<?php echo $evaluates_count['evaluate_count']; ?>)</a></li>
	...
	<div id="consulting_demo" class="ncs-loading">
		<div class="top" style="overflow: hidden;">
			...
			<div class="ncs-cosult-askbtn">
				<a href="SHOP_MAIN/goods/goodsconsult?goodsid=<?php echo $goods_id; ?>#askQuestion"
			...
			<?php else: ?>
				<div class="ncs-commend-main" >
					...
					<?php if(is_array($item['data']) || $item['data'] instanceof \think\Collection || $item['data'] instanceof \think\Paginator): $i = 0; $__LIST__ = $item['data'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
							<div class="ncs-cosult-list" >
								<dl class="asker">
									...
									<dd>
										...
										<time datetime="" pubdate="pubdate" class="m-l-20">[<?php echo $vo['consult_addtime']; ?>]</time>
									</dd>
								</dl>
								<dl class="ask-con">
									<dt>咨询内容：</dt>
								...
								<dl class="reply">
									...
									<dd>
										...
										<time  pubdate="pubdate">[<?php echo $vo['consult_reply_time']; ?>]</time>
									</dd>
								</dl>
								<!-- 回复内容e -->
								<?php endif; ?>
						...
						<?php endforeach; endif; else: echo "" ;endif; ?>
				<div class="more">
					<a href="SHOP_MAIN/goods/goodsconsult?goodsid=<?php echo $goods_id; ?>" target="_blank">查看全部咨询&gt;&gt;</a>
				</div>
			</div>
		<?php endif; ?>
		</div>

<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:48:"template/admin/Express/updateExpressCompany.html";i:1581654290;s:24:"template/admin/base.html";i:1581654310;s:41:"template/admin/controlCommonVariable.html";i:1581654310;s:30:"template/admin/pageCommon.html";i:1581654310;s:30:"template/admin/openDialog.html";i:1581654310;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<div class="set-style">
	<dl>
		...
		<dd>
			<p>
				<input id="company_name" type="text" value="<?php echo $expressCompany['company_name']; ?>">
			</p>
	...
	<dl>
		...
		<dd>
			<p>
				<input id="express_no" type="text" value="<?php echo $expressCompany['express_no']; ?>">
			</p>
		</dd>
	</dl>
	<dl>
		...
		<dd>
			<p>
				<input id="phone" type="text" value="<?php echo $expressCompany['phone']; ?>">
			</p>
	...
	<dl>
		...
		<dd>
			<div class="class-logo">
				<p>
					<img id="imglogo" src="__ROOT__/<?php echo $expressCompany['express_logo']; ?>">
				</p>
			</div>
			<div class="ncsc-upload-btn">
				<a href="javascript:void(0);">
					<span>
						...
						<input type="hidden" id="logo" value="<?php echo $expressCompany['express_logo']; ?>" />
					</span>
	...
	<dl>
		...
		<dd>
			<p>
				<input id="orders" type="number" value="<?php echo $expressCompany['orders']; ?>">
			</p>
	...
	<dl>
		<dt>是否启用物流:</dt>
			<dd>
					<input id="is_enabled" type="checkbox" class="checkbox" <?php if($expressCompany['is_enabled'] == 1): ?>checked="checked"<?php endif; ?> /> 
			</dd>
	</dl>
	
	<dl>
		<dt>是否设置为默认:</dt>
		<dd><input id="is_default" type="checkbox" class="checkbox" <?php if($expressCompany['is_default'] == 1): ?>checked="checked"<?php endif; ?>/></dd>
	</dl>
	<input type="hidden" id="co_id" value="<?php echo $expressCompany['co_id']; ?>">

<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:38:"template/shop/blue/Login/register.html";i:1579055856;s:42:"template/shop/blue/Login/registerBase.html";i:1579055856;s:35:"template/shop/blue/loginTopNav.html";i:1579055848;}*/ ?>
<!DOCTYPE html>
...
<div class="header w990">
	<div class="logo-info">
		<a href="SHOP_MAIN" class="logo"><img alt="logo" src="__UPLOAD__/<?php echo $web_info['logo']; ?>" /></a>
	</div>
</div>
...
<div class="reg-type">
	...
	<ul class="clearfix">
		...
		<li <?php if($login_type == 'plain'): ?>class="active" <?php endif; ?>><a <?php if($login_type == 'plain'): ?>href="javascript:void(0);"<?php else: ?>href="SHOP_MAIN/login/register"<?php endif; ?>>普通注册</a></li> 
		<?php endif; if(strpos($reg_config['register_info'],'mobile') !== false): ?>
		<li <?php if($login_type == 'mobile'): ?>class="active" <?php endif; ?>><a <?php if($login_type == 'mobile'): ?>href="javascript:void(0);"<?php else: ?>href="SHOP_MAIN/login/mobile"<?php endif; ?>>手机注册</a></li> 
		<?php endif; if(strpos($reg_config['register_info'],'email') !== false): ?>
		<li <?php if($login_type == 'email'): ?>class="active" <?php endif; ?>><a <?php if($login_type == 'email'): ?>href="javascript:void(0);"<?php else: ?>href="SHOP_MAIN/login/email"<?php endif; ?>>邮箱注册</a></li> 
		<?php endif; ?>
	</ul>
</div>
				<div class="reg-wrap">
	...
	<div class="footer-related">
		<div class="footer-info">
			<div class="info-text">
				<!-- 底部导航 -->
				<div class="txt">
					<p>Copyright © 2015-2025 Niushop开源商城&nbsp;版权所有 保留一切权利
					<br><a href="http://www.niushop.com.cn" target="_blank" style="text-decoration: none;color:#333333;">山西牛酷信息科技有限公司&nbsp;&nbsp;提供技术支持</a>

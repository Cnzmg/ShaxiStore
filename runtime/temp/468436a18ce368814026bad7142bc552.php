<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:61:"template/platform/Statistics/platformAccountMonthRecored.html";i:1581654378;s:27:"template/platform/base.html";i:1581654383;s:44:"template/platform/controlCommonVariable.html";i:1581654383;s:33:"template/platform/openDialog.html";i:1581654383;}*/ ?>
<!DOCTYPE html>
                ...
                <section class="panel panel-default">
                  ...
                  <footer class="panel-footer bg-white no-padder">
                    <div class="row text-center no-gutter">
                      <div class="col-xs-3 b-r b-light"><img src="PLATFORM_IMG/platform1.png" class="img"> <span class="h4 font-bold m-t block"><?php echo $AccountCount['account_all']; ?></span> <small class="text-muted m-b block">平台的总营业额</small> </div>
                      <div class="col-xs-3 b-r b-light"><img src="PLATFORM_IMG/platform2.png" class="img"> <span class="h4 font-bold m-t block"><?php echo $AccountCount['account']; ?></span> <small class="text-muted m-b block">平台资金总余额</small> </div>
                      <div class="col-xs-3 b-r b-light"><img src="PLATFORM_IMG/platform3.png" class="img"> <span class="h4 font-bold m-t block"><?php echo $AccountCount['account_return']; ?></span> <small class="text-muted m-b block">平台利润总额</small> </div>
                      <div class="col-xs-3"><img src="PLATFORM_IMG/platform4.png" class="img"> <span class="h4 font-bold m-t block"><?php echo $AccountCount['account_deposit']; ?></span> <small class="text-muted m-b block">保证金总额</small> </div>
                    </div>
                  </footer>
                   <footer class="panel-footer bg-white no-padder">
                    <div class="row text-center no-gutter">
                      <div class="col-xs-3 b-r b-light"><img src="PLATFORM_IMG/platform5.png" class="img"> <span class="h4 font-bold m-t block"><?php echo $AccountCount['account_order_money']; ?></span> <small class="text-muted m-b block">商城订单总额</small> </div>
                      <div class="col-xs-3 b-r b-light"><img src="PLATFORM_IMG/platform6.png" class="img"> <span class="h4 font-bold m-t block"><?php echo $AccountCount['account_withdraw']+$AccountCount['account_user_withdraw']; ?></span> <small class="text-muted m-b block">商城提现总额</small> </div>
                      <div class="col-xs-3 b-r b-light"><img src="PLATFORM_IMG/platform7.png" class="img"> <span class="h4 font-bold m-t block"><?php echo $AccountCount['shop_all_canwithdraw']; ?></span> <small class="text-muted m-b block">店铺总余额</small> </div>
                      <div class="col-xs-3"><img src="PLATFORM_IMG/platform8.png" class="img"> <span class="h4 font-bold m-t block"><?php echo $AccountCount['account_withdraw']; ?></span> <small class="text-muted m-b block">店铺总提现</small> </div>
                    </div>
                  </footer>
                </section>
              </div>

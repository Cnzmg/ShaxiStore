<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:40:"template/admin/Goods/goodsGroupList.html";i:1581654293;s:24:"template/admin/base.html";i:1581654310;s:41:"template/admin/controlCommonVariable.html";i:1581654310;s:30:"template/admin/pageCommon.html";i:1581654310;s:30:"template/admin/openDialog.html";i:1581654310;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<li><a class="nscs-table-handle_green" href="ADMIN_MAIN/goods/addgoodsgroup"><i class="fa fa-plus-circle"></i>&nbsp;添加商品标签</a></li>
...
function tab_switch(module_id){
	...
	function LoadingInfo(page_index) {
		$.ajax({
			type : "post",
			url : "ADMIN_MAIN/goods/goodsGroupList",
			data : {
				...
				if (data["data"].length > 0) {
					for (var i = 0; i < data["data"].length; i++) {
						...
						if(data["data"][i]['picture']['pic_cover'] != ''){
							html +='<img src="__ROOT__/'+data["data"][i]['picture']['pic_cover']+'" style="height:30px;">';	
						}else{
						...
						html +='<td style="text-align: center;"><a href="ADMIN_MAIN/goods/updategoodsgroup?group_id='+data["data"][i]['group_id']+'">修改</a>&nbsp;&nbsp;';	
					...
					html += '当前系统还没有商品标签，<a href="ADMIN_MAIN/goods/addgoodsgroup">马上添加</a>';
					html += '</div>';
					html += '</th></tr>';

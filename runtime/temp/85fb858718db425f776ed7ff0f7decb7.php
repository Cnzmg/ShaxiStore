<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:39:"template/admin/Order/returnSetting.html";i:1581654298;s:24:"template/admin/base.html";i:1581654310;s:41:"template/admin/controlCommonVariable.html";i:1581654310;s:30:"template/admin/pageCommon.html";i:1581654310;s:30:"template/admin/openDialog.html";i:1581654310;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<div class="set-style">
	<dl>
		...
		<dd>
			<p><input id="address" type="text" value="<?php echo $info['shop_address']; ?>"></p>
	...
	<dl>
		...
		<dd>
			<p><input id="receive" type="text" value="<?php echo $info['seller_name']; ?>"></p>
	...
	<dl>
		...
		<dd>
			<p><input id="phone" type="text" value="<?php echo $info['seller_mobile']; ?>"></p>
	...
	<dl>
		<dt>邮编:</dt>
		<dd>
			<p><input id="zip" type="text" value="<?php echo $info['seller_zipcode']; ?>"></p>
 ...
 <script>
	...
	function addReturnAjax() {
		...
		$.ajax({
			type : "post",
			url : "ADMIN_MAIN/order/returnsetting",
			data : {
				'address' : address,
				'real_name' : receive,
				'mobile' : phone,

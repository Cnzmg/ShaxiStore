<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:35:"template/admin/Shop/shopConfig.html";i:1581654303;s:24:"template/admin/base.html";i:1581654310;s:41:"template/admin/controlCommonVariable.html";i:1581654310;s:30:"template/admin/pageCommon.html";i:1581654310;s:30:"template/admin/openDialog.html";i:1581654310;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<div class="set-style">
	...
	<dl>
		<dt>店铺logo:</dt>
		<dd>
			<div class="class-logo"><p><img id="imgLogo"src="__UPLOAD__/<?php echo $shop_info['base_info']['shop_logo']; ?>" ></p></div>
			<div class="ncsc-upload-btn"> 
			    <a href="javascript:void(0);"><span>
			        ...
			        <input type="hidden"id="Logo"value="<?php echo $shop_info['base_info']['shop_logo']; ?>"/></span><p><!-- <i class="icon-upload-alt"></i> -->上传图片</p>
			    </a> 
			</div>
	...
	<dl>
		<dt>横幅:</dt>
		<dd>
			<div class="class-logo"><p style="width: 600px;"><img id="imgLogo1"src="__UPLOAD__/<?php echo $shop_info['base_info']['shop_banner']; ?>" ></p></div>
			<div class="ncsc-upload-btn"> 
			    <a href="javascript:void(0);"><span>
			        ...
			        <input type="hidden"id="Logo1"value="<?php echo $shop_info['base_info']['shop_banner']; ?>"/></span><p><!-- <i class="icon-upload-alt"></i> -->上传图片</p>
			    </a> 
			</div>
			<p class="hint"><br><span style="color:orange;">建议使用宽600像素-高60像素内的GIF或PNG透明图片；点击下方"提交"按钮后生效。</span></p>
		</dd>
	...
	<dl>
		<dt>店铺头像:</dt>
		<dd>
			<div class="class-logo"><p><img id="imgLogo2"src="__UPLOAD__/<?php echo $shop_info['base_info']['shop_avatar']; ?>" ></p></div>
			<div class="ncsc-upload-btn"> 
			    <a href="javascript:void(0);"><span>
			        ...
			        <input type="hidden"id="Logo2"value="<?php echo $shop_info['base_info']['shop_avatar']; ?>"/></span><p><!-- <i class="icon-upload-alt"></i> -->上传图片</p>
			    </a> 
			</div>
			<p class="hint"><br><span style="color:orange;">建议使用宽600像素-高60像素内的GIF或PNG透明图片；点击下方"提交"按钮后生效。</span></p>
		</dd>
	...
	<dl>
		<dt>QQ:</dt>
		<dd>
			<p><input name="UserCode" id="shop_qq" type="text" value="<?php echo $shop_info['base_info']['shop_qq']; ?>"> </p>
	...
	<dl>
		<dt>阿里旺旺:</dt>
		<dd>
			<p><input name="UserCode" id="shop_ww" type="text" value="<?php echo $shop_info['base_info']['shop_ww']; ?>"> </p>
	...
	<dl>
		<dt>商家电话:</dt>
		<dd>
			<p><input name="UserCode" id="shop_phone" type="text" value="<?php echo $shop_info['base_info']['shop_phone']; ?>"> </p>
	...
	<dl>
		<dt>seo关键字:</dt>
		<dd>
			<p><input name="UserCode" id="shop_keywords" type="text" value="<?php echo $shop_info['base_info']['shop_keywords']; ?>"> </p>

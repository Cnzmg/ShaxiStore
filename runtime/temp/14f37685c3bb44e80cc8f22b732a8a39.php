			...
			success : function(data) {
				...
				if (data["data"].length > 0) {
					for (var i = 0; i < data["data"].length; i++) {
						...
						html += '<td class="center"><a href="PLATFORM_MAIN/account/shopaccountrecordslist?shop_id='+data['data'][i]['shop_id']+'">详情</a></td>';
						html += '</tr>';
					}
				} else {

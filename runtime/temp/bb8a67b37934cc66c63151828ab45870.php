<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:47:"template/admin/Express/freightTemplateEdit.html";i:1581654290;s:24:"template/admin/base.html";i:1581654310;s:41:"template/admin/controlCommonVariable.html";i:1581654310;s:30:"template/admin/pageCommon.html";i:1581654310;s:30:"template/admin/openDialog.html";i:1581654310;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
					...
					<div class="dcity clearfix">
						...
						<div class="ecity gcity">
							<span class="group-label">
								...
								<label for="first_region_<?php echo $k; ?>"><?php echo $area['area_name']; ?></label>
							</span>
						</div>
						...
						<div class="province-list">
							...
							<div class="ecity">
								<span class="gareas">
									...
									<label class="disabled" for="second_region_<?php echo $k; ?>_<?php echo $province['province_id']; ?>"><?php echo $province['province_name']; ?></label>
									<?php else: ?>
									...
									<label for="second_region_<?php echo $k; ?>_<?php echo $province['province_id']; ?>"><?php echo $province['province_name']; ?></label>
									<?php endif; ?>
								...
								<div class="citys" id="citys_<?php echo $province['province_id']; ?>">
									<?php if(is_array($province['city_list']) || $province['city_list'] instanceof \think\Collection || $province['city_list'] instanceof \think\Paginator): if( count($province['city_list'])==0 ) : echo "" ;else: foreach($province['city_list'] as $third=>$city): ?>
										<span class="areas">
											...
											<input disabled="disabled" data-is-disabled="1" data-third-parent-index="<?php echo $k; ?>" data-province-id="<?php echo $province['province_id']; ?>" value="<?php echo $city['city_id']; ?>" id="third_<?php echo $k; ?>_<?php echo $city['city_id']; ?>" type="checkbox" />
											<label class="disabled" for="third_<?php echo $k; ?>_<?php echo $city['city_id']; ?>"><?php echo $city['city_name']; ?></label>
											<?php else: ?>
											<input data-third-parent-index="<?php echo $k; ?>" data-province-id="<?php echo $province['province_id']; ?>" value="<?php echo $city['city_id']; ?>" id="third_<?php echo $k; ?>_<?php echo $city['city_id']; ?>" type="checkbox" />
											<label for="third_<?php echo $k; ?>_<?php echo $city['city_id']; ?>"><?php echo $city['city_name']; ?></label>
											<?php endif; ?>
										</span>
									<?php endforeach; endif; else: echo "" ;endif; ?>

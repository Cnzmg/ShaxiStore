<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:35:"template/platform/Wchat/qrcode.html";i:1581654382;s:27:"template/platform/base.html";i:1581654383;s:44:"template/platform/controlCommonVariable.html";i:1581654383;s:33:"template/platform/openDialog.html";i:1581654383;}*/ ?>
<!DOCTYPE html>
...
.l{float:left;}
.r{float:right;}
.qrcode{width:320px;height:569px;background:#f5f5f5;position:relative;z-index:;margin:0 auto;}
.form{width:600px;}
...
<section class="panel panel-default">
	<header class="panel-heading font-bold"> 自定义推广二维码 </header>
	<div class="panel-body">
		<div class="row">
	<input type="hidden" id="id" value="<?php echo $id; ?>">
	<div class="col-md-4">
	<div class="qrcode" id="divBlock">
	   <?php if($info['background'] == ''): ?>
	   	<img id="imgLogo" src="">
	   <?php else: ?>
	   	<img id="imgLogo" src="__UPLOAD__/<?php echo $info['background']; ?>">
	   <?php endif; ?>
		<img id="header" src="ADMIN_IMG/icon-header.png" style="left:<?php echo $info['header_left']; ?>;top:<?php echo $info['header_top']; ?>;" ondragstart="return false">
		<img id="logo" src="PLATFORM_IMG/logo1.png" style="left:<?php echo $info['logo_left']; ?>;top:<?php echo $info['logo_top']; ?>;<?php if($info["is_logo_show"] == '0'): ?>display:none;<?php endif; ?>" ondragstart="return false">
		<img id="code" src="ADMIN_IMG/icon-code.png" style="left:<?php echo $info['code_left']; ?>;top:<?php echo $info['code_top']; ?>;" ondragstart="return false">
		<span id="name" style="left:<?php echo $info['name_left']; ?>;top:<?php echo $info['name_top']; ?>;color:<?php echo $info['nick_font_color']; ?>;font-size:<?php echo $info['nick_font_size']; ?>px;" ondragstart="return false">昵称</span>
	</div></div>
	<div class="col-md-8">
	<div class="form">
		<div class="tip">
			...
			<div class="form-group">
				...
				<a href="javascript:void(0);" style="display:block;position:relative;z-index:1;">
                                            		...
                                            		<input hidefocus="true" size="1" class="input-file" name="file_upload"
														...
														<input type="hidden" id="Logo" value="<?php echo $info['background']; ?>" />
													</span>
													<a class="btn btn-default"><i class="fa fa-cloud-upload text"></i><span class="text">上传图片</span></a>
												</a>
			<p class="hint"><br><span style="color:orange;">建议使用宽640像素-高1138像素内的GIF或PNG透明图片；点击下方"提交"按钮后生效。</span></p>
			</div>
			<div class="form-group">
				<label>昵称文本颜色:</label>
				<input name="UserCode" class="form-control" id="nick_font_color" type="color" value="<?php echo $info['nick_font_color']; ?>">
			</div>
			<div class="form-group">
				<label>昵称字体大小（像素）:</label>
				<input name="UserCode" class="form-control" id="nick_font_size" type="number" min="10" max="36" step="1" size="4" value="<?php echo $info['nick_font_size']; ?>"></p>
			</div>
			<div class="form-group">
				<label>是否显示logo:</label>
				<label class="switch">
                    <input id="is_logo_show" type="checkbox" <?php if($info['is_logo_show'] == '1'): ?>checked <?php endif; ?>>
                	<span></span> 
                </label>
			</div>
...
/* 	function imgUpload(event) {
	...
	function save(){
		...
		$.ajax({
			type : "post",
			url : "PLATFORM_MAIN/Wchat/qrcode",
			data : {
				'id':id,

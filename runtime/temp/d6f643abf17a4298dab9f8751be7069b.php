<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:36:"template/platform/Shop/shopList.html";i:1581654377;s:27:"template/platform/base.html";i:1581654383;s:44:"template/platform/controlCommonVariable.html";i:1581654383;s:27:"template/platform/page.html";i:1581654384;s:33:"template/platform/openDialog.html";i:1581654383;}*/ ?>
<!DOCTYPE html>
...
<div class="row padder-v">
	...
	<div class="col-sm-2">
		<select class="input-sm form-control" id="shop_type">
			<option value="0">请选择所属等级...</option> <?php if(is_array($shop_type_list) || $shop_type_list instanceof \think\Collection || $shop_type_list instanceof \think\Paginator): if( count($shop_type_list)==0 ) : echo "" ;else: foreach($shop_type_list as $key=>$vs): ?>
			<option value="<?php echo $vs['instance_typeid']; ?>"><?php echo $vs['type_name']; ?></option>
			<?php endforeach; endif; else: echo "" ;endif; ?>
		</select>
	</div>
	<div class="col-sm-2">

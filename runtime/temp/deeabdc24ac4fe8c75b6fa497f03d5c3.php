<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:46:"template/admin/Account/shopGoodsSalesRank.html";i:1579055960;s:24:"template/admin/base.html";i:1579055938;s:41:"template/admin/controlCommonVariable.html";i:1579055938;s:30:"template/admin/pageCommon.html";i:1579055938;s:30:"template/admin/openDialog.html";i:1579055938;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
.rank-ul li table tr td {
	height: 34px;
	line-height: 34px;
}

.rank-ul li table tr td:nth-child(1) {
	width: 40px;
	text-align: center;
}

.rank-ul li table tr td:nth-child(2) {
	width: 220px;
	text-align: left;
	padding-left: 20px;
	font-size: 13px;
...
.rank-ul li table tr td:nth-child(4) {
	color: rgba(255, 0, 0, 0.74);
	font-size: 18px;
}

.rank-ul li table tr td:nth-child(3) {
	width: 60px;
}
...
<div class="row">
	<div class="rank-box">
		...
		<ul class="rank-ul">
			...
			<li onclick="load_url(<?php echo $goods_info['goods_id']; ?>);" title="<?php echo $goods_info['goods_name']; ?>">
				<table>
					<tr>
						<td style="border-right: 1px solid #e8e8e8;"><?php echo $k + 1; ?></td>
...
<script>
function load_url(goods_id){
	window.location.href="ADMIN_MAIN/account/shopgoodsaccountlist?goods_id="+goods_id;
}
</script>

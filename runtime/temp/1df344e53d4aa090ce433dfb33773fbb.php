<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:32:"template/admin/Auth/addUser.html";i:1579055960;s:24:"template/admin/base.html";i:1579055938;s:41:"template/admin/controlCommonVariable.html";i:1579055938;s:30:"template/admin/pageCommon.html";i:1579055938;s:30:"template/admin/openDialog.html";i:1579055938;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<div class="set-style">
	<dl>
		...
		<dd>
			<p><input id="admin_name" type="text"></p>
	...
	<dl>
		...
		<dd>
			<p><input id="user_password" type="password"></p>
	...
	<button class="edit_button" onclick="addUserAjax()">提交</button>
</div>
<script>
/**
 *模块输入信息验证

<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:41:"template/admin/Complain/complainList.html";i:1581654284;s:24:"template/admin/base.html";i:1581654310;s:41:"template/admin/controlCommonVariable.html";i:1581654310;s:30:"template/admin/pageCommon.html";i:1581654310;s:30:"template/admin/openDialog.html";i:1581654310;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
    ...
    <tr>
        <th style="line-height:33px;">
            ...
            <select id="complain_subject">
                ...
                <?php if(is_array($complainSubject) || $complainSubject instanceof \think\Collection || $complainSubject instanceof \think\Paginator): if( count($complainSubject)==0 ) : echo "" ;else: foreach($complainSubject as $key=>$v): ?>
                <option value="<?php echo $v['complain_subject_content']; ?>"><?php echo $v['complain_subject_content']; ?></option>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
            投诉状态：

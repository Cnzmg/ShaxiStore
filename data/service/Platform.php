        ...
        if(!empty($block_info))
        {
            ...
            if(!empty($base_info)){
                ...
                if(!empty($base_info['recommend_goods_category_1'])){
                    ...
                    $goods_list_1 = $goods->where('category_id_3 = '.$base_info['recommend_goods_category_1'])->limit(6)->field('goods_id,goods_name,price,promotion_price,point_exchange_type,point_exchange,give_point,stock,picture,introduction')->select();
                    if(empty($goods_list_1)){
                        $goods_list_1 = $goods->where('category_id_2 = '.$base_info['recommend_goods_category_1'])->limit(6)->field('goods_id,goods_name,price,promotion_price,point_exchange_type,point_exchange,give_point,stock,picture,introduction')->select();
                    }
                    if(empty($goods_list_1)){
                        $goods_list_1 = $goods->where('category_id_1 = '.$base_info['recommend_goods_category_1'])->limit(6)->field('goods_id,goods_name,price,promotion_price,point_exchange_type,point_exchange,give_point,stock,picture,introduction')->select();
                    }
                    if(!empty($goods_list_1)){
                ...
                if(!empty($base_info['recommend_goods_category_2'])){
                    $goods = new NsGoodsModel();
                    $goods_list_2 = $goods->where('category_id_3 = '.$base_info['recommend_goods_category_2'])->limit(6)->field('goods_id,goods_name,price,promotion_price,point_exchange_type,point_exchange,give_point,stock,picture,introduction')->select();
                    if(empty($goods_list_2)){
                        $goods_list_2 = $goods->where('category_id_2 = '.$base_info['recommend_goods_category_2'])->limit(6)->field('goods_id,goods_name,price,promotion_price,point_exchange_type,point_exchange,give_point,stock,picture,introduction')->select();
                    }
                    if(empty($goods_list_2)){
                        $goods_list_2 = $goods->where('category_id_1 = '.$base_info['recommend_goods_category_2'])->limit(6)->field('goods_id,goods_name,price,promotion_price,point_exchange_type,point_exchange,give_point,stock,picture,introduction')->select();
                    }
                ...
                if(!empty($base_info['recommend_goods_category_3'])){
                    $goods = new NsGoodsModel();
                    $goods_list_3 = $goods->where('category_id_3 = '.$base_info['recommend_goods_category_3'])->limit(6)->field('goods_id,goods_name,price,promotion_price,point_exchange_type,point_exchange,give_point,stock,picture,introduction')->select();
                    if(empty($goods_list_3)){
                        $goods_list_3 = $goods->where('category_id_2 = '.$base_info['recommend_goods_category_3'])->limit(6)->field('goods_id,goods_name,price,promotion_price,point_exchange_type,point_exchange,give_point,stock,picture,introduction')->select();
                    }
                    if(empty($goods_list_3)){
                        $goods_list_3 = $goods->where('category_id_1 = '.$base_info['recommend_goods_category_3'])->limit(6)->field('goods_id,goods_name,price,promotion_price,point_exchange_type,point_exchange,give_point,stock,picture,introduction')->select();
                    }
...
//         }
    ...
    /**
     * (non-PHPdoc)
     * @see \data\api\IPlatform::addShopNavigationTemplate()
     */
    public function addShopNavigationTemplate($template_name, $template_url, $is_use, $use_type){
    
        $shop_navigation_temp_model = new NsShopNavigationTemplateModel();
        $data = array(
        ...
        $shop_navigation_temp_model->save($data);
        return $shop_navigation_temp_model->template_id;
    }
    
    /**
     * (non-PHPdoc)
     * @see \data\api\IPlatform::delShopNavigationTemplate()
     */
    public function delShopNavigationTemplate($template_id, $condition = ''){
    
        if(!empty($template_id)){
            $condition['template_id']   = $template_id;
        }
        $shop_navigation_temp_model = new NsShopNavigationTemplateModel();
        $res = $shop_navigation_temp_model->destroy($condition);
        return $res;
    }    

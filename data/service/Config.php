...
class Config extends BaseService implements IConfig
{
     ...
     * @param unknown $is_use
     */
    public function addComplainConfig($instance_id, $key, $value, $desc, $is_use){
        $res = $this->addConfig($instance_id, $key, $value, $desc, $is_use);
        return $res;
    }
     ...
     * @param unknown $is_use
     */
    public function updateComplainConfig($instance_id, $key, $value, $desc, $is_use){
        $res = $this->updateConfig($instance_id, $key, $value, $desc, $is_use);
        return $res;
    }
